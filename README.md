...
* Run main.py to read ECHAM-HAM model data and ATom data, perform the integration of model modes over the limits of ATom modes from observations


* Run Thesis_plot.py to create multipanel plot of model vs. Atom number concentration. It also includes subregions in the southern ocean color-coded in the plot with statistics.
